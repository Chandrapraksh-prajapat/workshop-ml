...
MODEL_NAME = "glove-wiki-gigaword-50"  # You can change this to any other model available in Gensim's API
...
def _get_model():
    ...
    if _model is None:
            ...
            logger.info(f"Embedding Loaded , Vocab Size : {len(_model.index_to_key)}")
    return _model
